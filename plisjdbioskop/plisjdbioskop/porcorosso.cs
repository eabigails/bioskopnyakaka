...
{
    public partial class porcorosso : Form
    {
        Panel porcos = new Panel();
        ...
        private void porcorosso_Load(object sender, EventArgs e)
        {
            ...
            picture.Image = Image.FromFile(@"C:\Users\surab\source\repos\plisjdbioskop\plisjdbioskop\Poster\PorcoRosso_250x375_R2.jpg");
            ...
            porcos.Location = new Point(340, 25);
            porcos.Name = "panel1";
            porcos.Size = new Size(280, 300);
            porcos.TabIndex = 0;
            porcos.BackColor = Color.LightBlue;
            Controls.Add(porcos);

            porcos.Controls.Clear();
            for (int i = 0; i < 10; i++)
            {
                for (int a = 0; a < 10; a++)
                {
