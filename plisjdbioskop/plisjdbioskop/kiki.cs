...
{
    public partial class kiki : Form
    {
        Panel kikis = new Panel();
        ...
        private void kiki_Load(object sender, EventArgs e)
        {
            this.BackColor = Color.Olive;


            kikis.Location = new Point(340, 25);
            kikis.Name = "panel1";
            kikis.Size = new Size(280, 300);
            kikis.TabIndex = 0;
            kikis.BackColor = Color.SandyBrown;
            Controls.Add(kikis);
            ...
            movie1.Text = "Kiki's Delivery Service";
            ...
            picture.Image = Image.FromFile(@"C:\Users\surab\source\repos\plisjdbioskop\plisjdbioskop\Poster\kiki.jpg");
