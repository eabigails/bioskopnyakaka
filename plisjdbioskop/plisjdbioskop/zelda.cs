...
namespace plisjdbioskop
{
    public partial class zelda : Form
    {
        ...
        private void zelda_Load(object sender, EventArgs e)
        {
            ...
            zeldas.Location = new Point(340, 25);
            zeldas.Name = "panel1";
            zeldas.Size = new Size(280, 300);
            zeldas.TabIndex = 0;
            zeldas.BackColor = Color.MistyRose;
            Controls.Add(zeldas);
            ...
            picture.Image = Image.FromFile(@"C:\Users\surab\source\repos\plisjdbioskop\plisjdbioskop\Poster\zeldaghibliposter3.jpg");
