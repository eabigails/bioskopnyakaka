...
{
    public partial class totoro : Form
    {
        Panel totorook = new Panel();
        ...
        private void totoro_Load(object sender, EventArgs e)
        {
            this.BackColor = Color.LightYellow;

            totorook.Location = new Point(340, 25);
            totorook.Name = "panel1";
            totorook.Size = new Size(280, 300);
            totorook.TabIndex = 0;
            totorook.BackColor = Color.LightGray;
            Controls.Add(totorook);
            ...
            picture.Image = Image.FromFile(@"C:\Users\surab\source\repos\plisjdbioskop\plisjdbioskop\Poster\My-Neighbor-Totoro-Vintage-Movie-Poster-Original-Japanese-1-Panel-20x29-8302.jpg");
