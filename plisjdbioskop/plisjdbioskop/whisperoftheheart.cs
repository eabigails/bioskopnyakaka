...
{
    public partial class whisperoftheheart : Form
    {
        Panel whispers = new Panel();
        ...
        public whisperoftheheart()
        {
            InitializeComponent();
        }

        private void whisperoftheheart_Load(object sender, EventArgs e)
        {
            this.BackColor = Color.PaleGreen;
            whispers.Location = new Point(340, 25);
            whispers.Name = "panel1";
            whispers.Size = new Size(280, 300);
            whispers.TabIndex = 0;
            whispers.BackColor = Color.Lavender;
            Controls.Add(whispers);

            Label movie1 = new Label();
            movie1.AutoSize = true;
            movie1.Location = new Point(28, 20);
            movie1.Text = "Whisper of the heart";
            ...
            picture.Image = Image.FromFile(@"C:\Users\surab\source\repos\plisjdbioskop\plisjdbioskop\Poster\whisperoftheheart.jpg");
