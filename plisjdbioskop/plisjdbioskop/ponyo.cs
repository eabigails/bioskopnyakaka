...
{
    public partial class ponyo : Form
    {
        Panel ponyos = new Panel();
        ...
        private void ponyo_Load(object sender, EventArgs e)
        {
            this.BackColor = Color.LightGreen;

            ponyos.Location = new Point(340, 25);
            ponyos.Name = "panel1";
            ponyos.Size = new Size(280, 300);
            ponyos.TabIndex = 0;
            ponyos.BackColor = Color.AliceBlue;
            Controls.Add(ponyos);
